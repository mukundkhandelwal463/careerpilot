                  ...
                  <div style={{ flex: 1, position: 'relative' }}>
                    ...
                    <div style={{ position: 'absolute', inset: 0, opacity: currentScreen === 1 ? 1 : 0, transition: 'opacity 0.4s ease', pointerEvents: currentScreen === 1 ? 'auto' : 'none', padding: '18px 20px', display: 'flex', flexDirection: 'column', gap: '14px' }}>
                      ...
                      <div style={{ background: 'rgba(16,185,129,0.08)', borderRadius: '10px', padding: '12px', border: '1px solid rgba(16,185,129,0.2)' }}>
                        <span style={{ color: '#34d399', fontSize: '0.72rem', fontWeight: 700, display: 'block', marginBottom: '6px' }}>AI ENGINE KEYWORDS RECOMMENDED:</span>
                        <div style={{ display: 'flex', gap: '6px', flexWrap: 'wrap' }}>
          ...
          <div style={{
            ...
            <div>
              ...
              <p style={{ fontSize: '0.98rem', color: '#64748b', lineHeight: 1.65, margin: '0 0 24px 0' }}>
                CareerPilot parses candidate resumes against job descriptions, identifying missing skills, quantifying ATS match scores, and suggesting high-impact keywords dynamically generated by our AI engine.
              </p>
            ...
            >
              ...
              {[
                ...
                },
                {
                  ...
                  color: '#06b6d4',
                  bg: '#ecfeff',
                  desc: 'Select an executive LaTeX template. Auto-fill AI keywords & export high-conversion PDF.',
                ...
                },
                {
                  ...
                  color: '#9333ea',
                  bg: '#f3e8ff',
                  desc: 'Define your goal role (SDE/ML). CareerPilot AI maps your skill gaps into a study plan with streak tracking.',
                  link: '/preparation',
        ...
        <section className="section" id="featuresSection" style={{ padding: '40px 0 90px' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '28px', maxWidth: '1240px', margin: '0 auto' }}>
            {[
              ...
              { id: 'roadmap', category: 'career', icon: Target, color: '#0891b2', bg: '#ecfeff', title: 'Career Roadmap Visualizer', desc: 'Provide your target role (Data Scientist, DevOps, SDE). CareerPilot AI Engine generates a custom level-by-level study roadmap mapped to your CV.', highlights: ['Target Role Skill Gap Analysis', 'Level-by-Level Study Roadmap', 'CV-to-Role Mapping Engine'], link: '/preparation', linkText: 'Generate Roadmap' },
          ...
          <div style={{
            ...
            <div style={{ position: 'relative', zIndex: 1 }}>
              ...
              <p style={{ fontSize: '1.12rem', color: '#94a3b8', maxWidth: '680px', margin: '0 auto 36px auto', lineHeight: 1.65 }}>
                Join 50,000+ candidates using CareerPilot to optimize resumes with AI, master technical voice interviews, and land top software & ML engineering positions.
              </p>
